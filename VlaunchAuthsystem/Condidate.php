...
if($password==$Cpassword && $email==$ConfermMail){
    $sql= "INSERT INTO `signupdata` (`id`, `email`, `password`, `phoneNumber`, `alternateEmail`) VALUES (NULL, '$email', '$password', '$PhoneNumber', '$alternatEmail');";
    ...
    <div class="container">
        ...
        <header>
            ...
            <div>
                ...
                <div class="Recruiter">as a Condidate</div>
            </div>
        </header>
        <div class="search">
