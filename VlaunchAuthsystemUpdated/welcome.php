...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if($count==1){
    header("Location:candidateWelcome.php");
  }
  $sql="SELECT * FROM `recruiterdata` WHERE binary email ='$email' and password='$password'";
  $result = mysqli_query($conn, $sql);
    ...
    <div class="container-nav">
      ...
      <div class="btn-group" style="margin-left: 1184px;margin-top: 26px;">
        ...
        <ul class="dropdown-menu" style="height:100px">
          ...
          <li><a class="dropdown-item" href="Condidate.php" style="margin-top: -60px;">Candidate</a></li>
        </ul>
      </div>
    </div>
  </nav>
